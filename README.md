...
**The research is live (July 2026):** the paper — *The Width of a Voice: Placing Machine Imitation Inside Authors' Own Variation* — is published as a preprint at **[doi:10.5281/zenodo.21210010](https://doi.org/10.5281/zenodo.21210010)** (CC BY 4.0, targeting CHR 2027; that is the concept DOI, which always resolves to the latest version — currently v0.5.5, 2026-07-25), and the full companion release — instrument, validation harness, corpora, recorded results, and the complete adversarial-review record — is public at **[wbryanta/author-manifold](https://github.com/wbryanta/author-manifold)**. Essays and context: **[wbryanta.github.io](https://wbryanta.github.io)**.
...
A worked example at our own expense: score this README and it comes back at 22.0 em dashes per 1,000 words, 12.9× the celebrated-novelist median of 1.71 and 5.9× the AI median. It was written by a human who likes em dashes, about a study of whether liking em dashes means anything. That is the finding rather than a counterexample to it: the tell tracks register and habit, not authorship.
...
- **Paper:** published as a preprint, first posted 2026-07-05 — [doi:10.5281/zenodo.21210010](https://doi.org/10.5281/zenodo.21210010) (concept DOI: always resolves to the latest version; current release **v0.5.5, 2026-07-25**, versioned DOI [10.5281/zenodo.21562806](https://doi.org/10.5281/zenodo.21562806), CC BY 4.0). Targeting **CHR 2027** (Computational Humanities Research).
